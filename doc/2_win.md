...
PowerShell 保证在4.0以上, 3.0会有问题

- 将以下脚本放到被控机执行  ConfigureRemotingForAnsible.ps1
...
# Updated by Dag Wie毛rs <dag@wieers.com>
# Updated by Jordan Borean <jborean93@gmail.com>
# Updated by Erwan Qu茅lin <erwan.quelin@gmail.com>
...
- 检查端口是否开启, 防火墙放行 5985 5986
```angular2html
PS C:\Users\Administrator\Desktop> netstat -ano|findstr 5986
  TCP    0.0.0.0:5986           0.0.0.0:0              LISTENING       4
  TCP    [::]:5986              [::]:0                 LISTENING       4
  TCP    [::1]:64518            [::1]:5986             TIME_WAIT       0
  TCP    [::1]:64525            [::1]:5986             TIME_WAIT       0
  TCP    [::1]:64527            [::1]:5986             TIME_WAIT       0
PS C:\Users\Administrator\Desktop> netstat -ano|findstr 5985
  TCP    0.0.0.0:5985           0.0.0.0:0              LISTENING       4
  TCP    [::]:5985              [::]:0                 LISTENING       4
  TCP    [::1]:64509            [::1]:5985             TIME_WAIT       0
  TCP    [::1]:64510            [::1]:5985             TIME_WAIT       0
  TCP    [::1]:64515            [::1]:5985             TIME_WAIT       0
  TCP    [::1]:64516            [::1]:5985             TIME_WAIT       0
```